...
from tkinter import *
from Admin import AdmLogin  # Assuming Admin module exists with AdmLogin function
from voter import voterLogin  # Assuming voter module exists with voterLogin function
